<template>
    <el-card>
        <el-table border style="margin: 10px 0px;" :data="skuArr">
            ...
            <el-table-column label="名称" show-overflow-tooltip align="center" width="150px"
            ...
            <el-table-column label="操作" align="center" width="250px" fixed="right">
                <template #="{ row, $index }">
                    ...
                    <el-button type="primary" size="small" :icon="row.isSale == 1 ? 'Bottom' : 'Top'"
                        ...
                        v-btn="'btn.Sku.updown'"></el-button>
                    <!-- 更新按钮
                    <el-button type="primary" size="small" icon="Edit" @click="updateSku" title="修改SKU"></el-button> -->
                    <!-- 详情按钮 -->
                    <el-button type="primary" size="small" icon="InfoFilled" @click="findSku(row)" title="查看商品详情"
                        v-btn="'btn.Sku.detail'"></el-button>
                    <!-- Popconfirm气泡确认框 confirm:点击确认按钮时触发事件 -->
                    <el-popconfirm :title="`你确定要删除${row.skuName}?`" width="200px" @confirm="removeSku(row.id)">
                        <template #reference>
                            <!--  删除按钮 -->
                            <el-button type="primary" size="small" icon="Delete" title="删除" v-btn="'btn.Sku.remove'"></el-button>
                        </template>
                    </el-popconfirm>
                </template>
            </el-table-column>
        ...
        <!-- Drawer抽屉,展示商品详情 drawer:控制显示与隐藏 -->
