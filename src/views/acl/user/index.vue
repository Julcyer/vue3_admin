<template>
    ...
    <el-card style="margin: 10px 0px;">
        <el-button type="primary" size="default" @click="addUser" v-btn="'btn.User.add'">添加用户</el-button>
        <el-button type="primary" size="default" :disabled="selectIdArr.length ? false : true" @click="deleteSelectUser"
            v-btn="'btn.User.remove'">批量删除</el-button>
        <!-- table展示用户信息 -->
            ...
            <el-table-column label="操作" width="300px" align="center">
                <template #="{ row, $index }">
                    ...
                    <el-button type="primary" size="small" icon="Edit" @click="updateUser(row)"
                        v-btn="'btn.User.update'">编辑</el-button>
                    ...
                    <el-popconfirm :title="`你确定要删除${row.username}?`" width="260px" @confirm="deleteUser(row.id)">
                        <template #reference>
                            <el-button type="primary" size="small" icon="Delete"
                                v-btn="'btn.User.remove'">删除</el-button>
                        </template>
                    </el-popconfirm>
                </template>
            </el-table-column>
...
const addUser = () => {
    ...
    //清除上一次的错误的提示信息
    nextTick(() => {
        //clearValidate,el-form组件方法,清除表单的验证错误信息
...
.form {
    display: flex;
    /* justify-content:Flex容器中Flex项目在主轴上的对齐方式
